#!/usr/bin/env -S -P/${HOME}/.deno/bin:/opt/homebrew/bin deno run --allow-net --allow-read=weatherAlerts.1min.ts.vars.json --allow-write=weatherAlerts.1min.ts.vars.json
/*
